...
export default function CrossCuttingAnalysis({
  ...
  const crossCuttingTooltipContent = (
    <>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10" role="region" aria-label="Cross-cutting analysis summary">
          <MetricCard
            ...
            tooltipContent={<div>Placeholder tooltip for shared titles</div>}
          ...
          <MetricCard
            ...
            tooltipContent={<div>Placeholder tooltip for partner agencies</div>}
